...
namespace PackIT.UnitTest.Domain
{
    ...
    {
        [Fact]
        public void AddItem_Throws_PackingItemAlreadyExistsException_When_There_Is_Already_With_The_Same_Name()
        {
            //ARRANGE
        ...
        {
            var packingList = _factory.Create(Guid.NewGuid(), "MyList", Localization.Create("Xian,China"));
